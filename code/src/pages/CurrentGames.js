                ...
                tbody > {
                    this.state.games.map((item, index) => {
                            return ( <
                                ...
                                onClick = { this.joinMyPart.bind(this, index, item.id) } > Rejoindre < /td> <
                                td className = "exit-btn" >


                                <
                                Popup trigger = { < FontAwesomeIcon icon = { faSignOutAlt }
                                    />}
                                    modal
                                    nested > {
                                        close => ( <
                                            ...
                                            onClick = { this.leaveGame.bind(this, index, item.id, close) } > Êtes - vous sûr de vouloir quitter la partie ? < /button> <
                                            button className = "custom-button"
